...
const StatusPage = () => {
  ...
  return (
    <div>
        ...
        <div className="flex md:justify-between xs:justify-center items-center">
          ...
          <div className="mr-4">
            {currentStatus === "Online" ? (
              <img src={online} className="invert h-10 border-2 border-white" />
      ...
      <div className="border-l-2 border-orange-500 mt-24 h-[20rem] ml-auto mr-auto xl:w-1/2 text-white p-4">
        <div>
